...
function App() {
  ...
  return (
   <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
    ...
    <div className=" flex flex-row   bg-white justify-center  py-3 px-2 gap-12 rounded-sm text-[25px] text-[#344151] ">
       <button onClick={decreaseHandler} className="border-l-2 text-center w-20 border-[#bfbfbf text-5xl">
          -
       </button>
       <div className="font-bold text-red-600 gap-12 text-5xl">
         {count}
       </div>
